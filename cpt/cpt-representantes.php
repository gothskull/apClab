 ...
 **************************************************************************
*/
 	if(! function_exists('acl_add_cpt_representantes'))
 	{

 		function acl_add_cpt_representantes()
 		{
 			...
 			$labels = array(
 				...
 				'archives'              => _x( 'Representantes Archivo', '', $text_domain ),
 				...
 				'filter_items_list'     => _x( 'Filtrar Representantes por lista', '”. Added in 4.4', $text_domain ),
 				'items_list_navigation' => _x( 'Navegación de Representantes', '', $text_domain ),
 				'items_list'            => _x( 'Lista de Representantes', '', $text_domain ),
 			);
 			$args = array(
 	...
 	add_action('init','acl_add_cpt_representantes' );