...
/* 
 **************************************************************************
    CREA POST TYPE PROYECTOS
 **************************************************************************
*/
 	if(! function_exists('acl_add_cpt_proyectos'))
 	{

 		function acl_add_cpt_proyectos()
 		{
 			$singular    = 'Proyecto';
 			$plural      = 'Proyectos';
 			...
 			$labels = array(
 				...
 				'archives'              => _x( 'Proyectos Archivo', '', $text_domain ),
 				'insert_into_item'      => _x( 'Insertar en Proyecto', '', $text_domain ),
 				'uploaded_to_this_item' => _x( 'Cargado en este Proyecto', '', $text_domain ),
 				'filter_items_list'     => _x( 'Filtrar Proyectos por lista', '”. Added in 4.4', $text_domain ),
 				'items_list_navigation' => _x( 'Navegación de Proyectos', '', $text_domain ),
 				'items_list'            => _x( 'Lista de Proyectos', '', $text_domain ),
 			);
 			$args = array(
 	...
 	add_action('init','acl_add_cpt_proyectos' );
